...
Year1 <- "2025-01-01"           #1st Yr Powell/MSCP tables. Code calculates Year2 (1st yr Mead tables).
...
#Percent of Traces with Mead going Below 1,350 ft during the CY
...
years_to_exclude = c(2023,2024) # Add years here as a comma separated list to exclude them from the figure below
