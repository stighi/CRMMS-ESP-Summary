...
EOCY <- "2026-12-01"            #EOCY for Powell/Mead elevation ranges in summary points.
PowellOT_WYrn <- "2026-01-01"   #WY for Powell Operating Tier and Release Volume tables.
Year1 <- "2026-01-01"           #1st Yr Powell/MSCP tables. Code calculates Year2 (1st yr Mead tables).
...
# BR 8/19/24 added new table
#Percent of Traces with Powell Release Adjustment to Avoid Declining Below 3,500 ft during the CY

PowellConst <- as.data.frame(read_excel(Current_month_file, sheet = "PowellConstrained3500Bypass"))
rownames(PowellConst) <- PowellConst[,1]
PowellConst_LM <- as.data.frame(read_excel(Last_month_file, sheet = "PowellConstrained3500Bypass"))
rownames(PowellConst_LM) <- PowellConst_LM[,1]

PowellConst_1 <- c(PT(PowellConst, Year1, 1), PT(PowellConst_LM, Year1, 1), Diff(PT(PowellConst, Year1, 1), PT(PowellConst_LM, Year1, 1)))
PowellConst_2 <- c(PT(PowellConst, Year2, 1), PT(PowellConst_LM, Year2, 1), Diff(PT(PowellConst, Year2, 1), PT(PowellConst_LM, Year2, 1)))
PowellConst_3 <- c(PT(PowellConst, Year3, 1), PT(PowellConst_LM, Year3, 1), Diff(PT(PowellConst, Year3, 1), PT(PowellConst_LM, Year3, 1)))
PowellConst_4 <- c(PT(PowellConst, Year4, 1), PT(PowellConst_LM, Year4, 1), Diff(PT(PowellConst, Year4, 1), PT(PowellConst_LM, Year4, 1)))
PowellConst_5 <- c(PT(PowellConst, Year5, 1), PT(PowellConst_LM, Year5, 1), Diff(PT(PowellConst, Year5, 1), PT(PowellConst_LM, Year5, 1)))
tab_PowellConst <- data.frame(PowellConst_1, PowellConst_2, PowellConst_3, PowellConst_4, PowellConst_5)
row.names(tab_PowellConst) <- c(Current_month_rn,Previous_month_rn,"Difference")
names(tab_PowellConst) <- c(Year_format(Year1), Year_format(Year2), Year_format(Year3), Year_format(Year4), Year_format(Year5))

# BR 10/27/25 added new table
# Percent of Traces with Powell Release Adjustment to Avoid Declining Below 3,500 ft during the CY and 
# Release volume less than 7.48 maf

PowellConst748 <- as.data.frame(read_excel(Current_month_file, sheet = "PowellConstrained3500Less748"))
rownames(PowellConst748) <- PowellConst748[,1]
PowellConst748_LM <- as.data.frame(read_excel(Last_month_file, sheet = "PowellConstrained3500Less748"))
rownames(PowellConst748_LM) <- PowellConst748_LM[,1]

# PowellConst748_1 <- c(PT(PowellConst748, Year1, 1), PT(PowellConst748_LM, Year1, 1), Diff(PT(PowellConst748, Year1, 1), PT(PowellConst748_LM, Year1, 1)))
PowellConst748_2 <- c(PT(PowellConst748, Year2, 1), PT(PowellConst748_LM, Year2, 1), Diff(PT(PowellConst748, Year2, 1), PT(PowellConst748_LM, Year2, 1)))
PowellConst748_3 <- c(PT(PowellConst748, Year3, 1), PT(PowellConst748_LM, Year3, 1), Diff(PT(PowellConst748, Year3, 1), PT(PowellConst748_LM, Year3, 1)))
PowellConst748_4 <- c(PT(PowellConst748, Year4, 1), PT(PowellConst748_LM, Year4, 1), Diff(PT(PowellConst748, Year4, 1), PT(PowellConst748_LM, Year4, 1)))
PowellConst748_5 <- c(PT(PowellConst748, Year5, 1), PT(PowellConst748_LM, Year5, 1), Diff(PT(PowellConst748, Year5, 1), PT(PowellConst748_LM, Year5, 1)))
tab_PowellConst748 <- data.frame(PowellConst748_2, PowellConst748_3, PowellConst748_4, PowellConst748_5)
row.names(tab_PowellConst748) <- c(Current_month_rn,Previous_month_rn,"Difference")
names(tab_PowellConst748) <- c(Year_format(Year2), Year_format(Year3), Year_format(Year4), Year_format(Year5))
...
# BR 1/29/25 added new table
#Percent of Traces with Mead going Below 1,035 ft during the CY

Mead1035 <- as.data.frame(read_excel(Current_month_file, sheet = "MeadData.MeadBelow1035_Annual"))
rownames(Mead1035) <- Mead1035[,1]

Mead1035_LM <- as.data.frame(read_excel(Last_month_file, sheet = "MeadData.MeadBelow1035_Annual"))
rownames(Mead1035_LM) <- Mead1035_LM[,1]
Mead1035_1 <- c(PT(Mead1035, Year1, 1), PT(Mead1035_LM, Year1, 1), Diff(PT(Mead1035, Year1, 1), 
                                                                        PT(Mead1035_LM, Year1, 1)))
Mead1035_2 <- c(PT(Mead1035, Year2, 1), PT(Mead1035_LM, Year2, 1), Diff(PT(Mead1035, Year2, 1), 
                                                                        PT(Mead1035_LM, Year2, 1)))
Mead1035_3 <- c(PT(Mead1035, Year3, 1), PT(Mead1035_LM, Year3, 1), Diff(PT(Mead1035, Year3, 1), 
                                                                        PT(Mead1035_LM, Year3, 1)))
Mead1035_4 <- c(PT(Mead1035, Year4, 1), PT(Mead1035_LM, Year4, 1), Diff(PT(Mead1035, Year4, 1), 
                                                                        PT(Mead1035_LM, Year4, 1)))
Mead1035_5 <- c(PT(Mead1035, Year5, 1), PT(Mead1035_LM, Year5, 1), Diff(PT(Mead1035, Year5, 1), 
                                                                        PT(Mead1035_LM, Year5, 1)))
  
tab_Mead1035 <- data.frame(Mead1035_1, Mead1035_2, Mead1035_3, Mead1035_4, Mead1035_5)
row.names(tab_Mead1035) <- c(Current_month_rn,Previous_month_rn,"Difference")
names(tab_Mead1035) <- c(Year_format(Year1), Year_format(Year2), Year_format(Year3), Year_format(Year4),
                         Year_format(Year5))
...
# BR 6/24/25 added new table
#Percent of Traces with Mead going Below 1,000 ft during the CY

Mead1000 <- as.data.frame(read_excel(Current_month_file, sheet = "MeadData.MeadBelow1000_Annual"))
rownames(Mead1000) <- Mead1000[,1]

Mead1000_LM <- as.data.frame(read_excel(Last_month_file, sheet = "MeadData.MeadBelow1000_Annual"))
rownames(Mead1000_LM) <- Mead1000_LM[,1]
Mead1000_1 <- c(PT(Mead1000, Year1, 1), PT(Mead1000_LM, Year1, 1), Diff(PT(Mead1000, Year1, 1), 
                                                                        PT(Mead1000_LM, Year1, 1)))
Mead1000_2 <- c(PT(Mead1000, Year2, 1), PT(Mead1000_LM, Year2, 1), Diff(PT(Mead1000, Year2, 1), 
                                                                        PT(Mead1000_LM, Year2, 1)))
Mead1000_3 <- c(PT(Mead1000, Year3, 1), PT(Mead1000_LM, Year3, 1), Diff(PT(Mead1000, Year3, 1), 
                                                                        PT(Mead1000_LM, Year3, 1)))
Mead1000_4 <- c(PT(Mead1000, Year4, 1), PT(Mead1000_LM, Year4, 1), Diff(PT(Mead1000, Year4, 1), 
                                                                        PT(Mead1000_LM, Year4, 1)))
Mead1000_5 <- c(PT(Mead1000, Year5, 1), PT(Mead1000_LM, Year5, 1), Diff(PT(Mead1000, Year5, 1), 
                                                                        PT(Mead1000_LM, Year5, 1)))
  
tab_Mead1000 <- data.frame(Mead1000_1, Mead1000_2, Mead1000_3, Mead1000_4, Mead1000_5)
row.names(tab_Mead1000) <- c(Current_month_rn,Previous_month_rn,"Difference")
names(tab_Mead1000) <- c(Year_format(Year1), Year_format(Year2), Year_format(Year3), Year_format(Year4),
                         Year_format(Year5))
...
% Traces with Powell Release Adjustment to Avoid Declining Below 3,500 ft during the CY:
```{r ft.align="left", echo=FALSE}
TabFormat(tab_PowellConst)
```
* ADD BULLETS OF NOTE HERE

<br>
% Traces with Powell Release Adjustment to Avoid Declining Below 3,500 ft during the CY and Powell release less than 7.48 maf:
```{r ft.align="left", echo=FALSE}
TabFormat(tab_PowellConst748)
```
* ADD BULLETS OF NOTE HERE
...
% Traces with Lake Mead Elevation < 1,035 ft:
```{r ft.align="left", echo=FALSE}
TabFormat(tab_Mead1035)
```
* ADD BULLETS OF NOTE HERE
...
% Traces with Lake Mead Elevation < 1,000 ft in any month:
```{r ft.align="left", echo=FALSE}
TabFormat(tab_Mead1000)
```
...
Year_new = c("2025","2026","2027", "2028", "2029")

LCShortage_df <- data.frame(ESPRun = rep(c(Current_month, Previous_month), each = 5), 
                            Condition = rep(factor(LC_Condition, levels = LC_Condition)), 
                            Year_data = rep(Year_new, each = 10), 
    Trace_data = c(TSum(LCSurplus,"2025",1),(TSum(LCShortage, "2025",0)-TSum(LCSurplus,"2025",1)),
                   TSum(LCShortage, "2025",1),TSum(LCShortage, "2025",2),
                   TSum(LCShortage, "2025",3), TSum(LCSurplus_lm,"2025",1),
                   TSum(LCShortage_lm, "2025",0),(TSum(LCShortage_lm, "2025",1)-TSum(LCShortage_lm, "2025",0)),
                   TSum(LCShortage_lm, "2025",2),TSum(LCShortage_lm, "2025",3),
                   ...
                   TSum(LCSurplus,"2028",1), (TSum(LCShortage,"2028",0)-TSum(LCSurplus,"2028",1)), 
                   TSum(LCShortage,"2028",1), TSum(LCShortage,"2028",2), TSum(LCShortage,"2028",3),
                   TSum(LCSurplus_lm,"2028",1), (TSum(LCShortage_lm,"2028",0)-TSum(LCSurplus_lm,"2028",1)), 
                   TSum(LCShortage_lm,"2028",1), TSum(LCShortage_lm,"2028",2), TSum(LCShortage_lm,"2028",3),
                   TSum(LCSurplus,"2029",1), (TSum(LCShortage,"2029",0)-TSum(LCSurplus,"2029",1)),
                   TSum(LCShortage,"2029",1), TSum(LCShortage,"2029",2), TSum(LCShortage,"2029",3),
                   TSum(LCSurplus_lm,"2029",1), (TSum(LCShortage_lm,"2029",0)-TSum(LCSurplus_lm,"2029",1)),
                   TSum(LCShortage_lm,"2029",1), TSum(LCShortage_lm,"2029",2), TSum(LCShortage_lm,"2029",3)))
...
years_to_exclude = c(2023,2024,2025) # Add years here as a comma separated list to exclude them from the figure below
